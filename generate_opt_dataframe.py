...
def define_opt(opt_signal_probability, actionchannels, n_trials, pop_names, opt_signal_channel,opt_signal_amplitude,opt_signal_onset,opt_signal_present,opt_signal_population ):
    ...
    return opt_df, opt_channels_df, opt_amplitude_df, opt_onset_df,opt_populations_df #reward_t1, reward_t2


def GenOptSchedule(opt_signal_probability, actionchannels, n_trials,popdata, opt_signal_channel, opt_signal_amplitude, opt_signal_onset, opt_signal_present,opt_signal_population):
    
    print("begin GenOptSchedule")
    #reward_t1, reward_t2
    opt_df, opt_channels_df, opt_amplitude_df, opt_onset_df,opt_populations_df = define_opt(
        opt_signal_probability, actionchannels, n_trials,popdata, opt_signal_channel,opt_signal_amplitude, opt_signal_onset,opt_signal_present,opt_signal_population)
    ...
    print(opt_channels_df)
    return opt_df, opt_channels_df, opt_amplitude_df, opt_onset_df, opt_populations_df
